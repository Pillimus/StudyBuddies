  ...
  return (
    <div className="chats-wrap">
      <div className="chats-list">
        ...
        {chats.map(chat => (
          <div key={chat.id} className={`chat-row ${active.id === chat.id ? 'active' : ''}`}
        ...
        <div className="chat-window-header" onClick={() => setShowInfo(!showInfo)} style={{ cursor: 'pointer' }}>
          ...
          <div className="chat-window-title-wrap">
            ...
            <div className="chat-window-sub">
              ...
              {' · '}
              <span className="chat-expand-hint">expand for info</span>
            </div>
          </div>
        ...
        <div className="modal-overlay" onClick={() => setShowNew(false)}>
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            ...
            <div className="field">
              ...
              <input value={newUsers} onChange={e => setNewUsers(e.target.value)} placeholder="" autoFocus/>
            </div>
            {multipleUsers && (
              <>
                <div className="field">
                  <label>Chat name (optional)</label>
                  <input value={chatName} onChange={e => setChatName(e.target.value)} placeholder=""/>
                </div>
                <div className="field">
