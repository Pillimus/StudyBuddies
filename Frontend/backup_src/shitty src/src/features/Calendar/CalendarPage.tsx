...
import { CALENDAR_GROUPS } from '../../mock/mockData';
...
const emptyForm = () => ({
  ...
  type: 'study', for: 'Me', description: '', location: '',
});
                  ...
                  <>
                    ...
                    <div className="cal-events">
                      {dayEvents.slice(0, 3).map(ev => (
                        ...
                        >
                          <span className="chip-type-icon" style={{ color: TYPE_COLOR[ev.type] }}>{TYPE_ICON[ev.type]}</span>
          ...
          <div className="modal-box" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <div className="cal-detail-title">
                <span className="cal-detail-icon" style={{ color: TYPE_COLOR[selected.type] }}>{TYPE_ICON[selected.type]}</span>
            ...
            <div className="cal-detail-body">
              {[
                ...
                <div key={i} className="cal-detail-row">
                  <span className="cal-detail-label">{r.label}</span>
                  <span className="cal-detail-value">{r.value}</span>
                </div>
              ))}
            </div>
            <div className="modal-footer">
              <button className="btn-ghost teal-ghost" onClick={() => { markDone(selected.id); setSelected(null); }}>✓ Mark Done</button>
